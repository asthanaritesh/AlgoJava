...
public class Test {
    private String s; 
    public Test()  {  s = "Test For Reflection"; } 
...
{ 
	...
	{ 
		...
		// allows the object to access the field irrespective of the access specifier used with the field field.setAccessible(true); 
		...
		// allows the object to access the method irrespective of the access specifier used with the method methodcall3.setAccessible(true); 
